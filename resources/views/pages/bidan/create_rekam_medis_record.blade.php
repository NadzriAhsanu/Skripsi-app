    ...
    <div class="main-content">
        <section class="section">
            ...
            <div class="section-body">
                ...
                <div class="card">
                    <form action="{{ route('bidan.storeRekamMedis', $patient->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label>Pasien</label>
                                <select class="form-control selectric @error('patient_name') is-invalid @enderror"
                                name="patient_name">
                                <option value="">Select Pasien</option>
                                @foreach ($patients as $patient)
                                <option value="{{ $patient->name }}">{{$patient->patient_name}}</option>
                                @endforeach
                                </select>
                            </div>
